...
import Project.TicTacToe.Exception.GameOverException;
import Project.TicTacToe.Model.*;
...
public class RandomBotPlayingStrategy implements BotPlayingStrategy{
    ...
    public Move makeMove(Board board, Player bot){
        ...
        throw new GameOverException("There is no EmptyCells left in the Board");
    }
}
